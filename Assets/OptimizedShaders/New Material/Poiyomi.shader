Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/c7cc633d469412b48af9aaa8db36839e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				poiLight.finalLighting = lerp(poiLight.directColor, min(lerp(poiLight.indirectColor * float4(1,1,1,1), float4(1,1,1,1), (1.0 /*_LightingIgnoreAmbientColor*/)) * poiLight.occlusion + (sss * poiLight.directColor), poiLight.directColor), (1.0 /*_ShadowStrength*/)) * attenuation;
				#endif
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch((1.0 /*_MatcapUVMode*/))
				{
					case 0:
					{
						...
						matcapUV = noSknewViewNormal.rg * (0.452 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 1:
					{
						...
						matcapUV = float2(dot(worldViewRight, normal0), dot(worldViewUp, normal0)) * (0.452 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 2:
					{
						...
						matcapUV = uv * (0.452 /*_MatcapBorder*/) + 0.5;
						break;
					}
				}
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(1,0.8743453,0.6070304,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.8743453,0.6070304,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(1,0.8743453,0.6070304,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.8743453,0.6070304,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(1,0.8743453,0.6070304,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.8743453,0.6070304,1).a);
				#endif
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.45 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.directColor = lerp(poiLight.directColor, dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), (0.75 /*_LightingMonochromatic*/));
				poiLight.indirectColor = lerp(poiLight.indirectColor, dot(poiLight.indirectColor, float3(0.299, 0.587, 0.114)), (0.75 /*_LightingMonochromatic*/));
