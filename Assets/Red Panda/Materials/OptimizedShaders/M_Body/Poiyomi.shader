Shader "Hidden/Locked/.poiyomi/Old Versions/8.0/Poiyomi Toon/0f4454b533525d7499b7c558a82b313f"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				secondShadeMap.rgb *= float4(0.1034845,0.07311055,0.09609539,1).rgb; //* LightColor;
				float shadowMask = 1;
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float rim = 1 - smoothstep(min((0.2 /*_RimSharpness*/), rimWidth), rimWidth, viewDotNormal);
